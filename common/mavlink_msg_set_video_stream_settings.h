 ...
 * @param camera_id  Stream ID (1 for first, 2 for second, etc.)
 ...
 * @param uri  Video stream URI (mostly for UDP/RTP)
 ...
 *
 * @return  Stream ID (1 for first, 2 for second, etc.)
 */
 ...
 *
 * @return  Video stream URI (mostly for UDP/RTP)
 */
